...
# X axis param set
        ...
        self.xy_axis_param_frame.grid(row=1,column=0, sticky='ns',ipadx=10,pady=20)
        ...
        self.x_axis_range.grid(row=1, column=0,columnspan=3,pady=10)
        ...
        self.x_axis_custom.grid(row=1, column=3,columnspan=3)
        ...
        self.steps_entry.grid(row=2, column=3)
        ...
        self.function.grid(row=5, column=0, columnspan=3,pady=10)
        ...
        self.y_axis_custom.grid(row=5, column=3, columnspan=3)
